...
class CalcTA():
    ...
    def create_calk_dict(self, path_to_datfiles, calk_dict = "default"): 
        ...
        print("Using " + column_names.dic_sample_umol_per_kg + " to calculate TA. Can be changed in column_names file if necessary.")
    ...
    def create_calk_file(self, path_to_datfiles, calk_dict="default"): 
        ...
        if calk_dict == "default":
            ...
            self.df_ta[column_names.dic_for_ta] = np.where(self.df_ta[column_names.station] == 8888, self.df_ta[column_names.dic_certified_umolkg], self.df_ta[column_names.dic_sample_umol_per_kg]) 
            # 20240724 - ESD - AWI >
